...
#[ApiResource(operations: [
    new GetCollection(normalizationContext: ['groups' => ['produit:collection', 'categorie:collection', 'quantification:collection']]),
    new Post(),
    new Get(normalizationContext: ['groups' => ['produit:collection', 'categorie:collection', 'quantification:collection']]),
