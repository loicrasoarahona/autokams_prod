...
#[ApiFilter(OrderFilter::class, properties: ['approvisionnement.dateAchat'], arguments: ['orderParameterName' => 'order'])]
class ApprovisionnementDetail
{
    ...
    public function addVenteDetail(VenteDetail $venteDetail): static
    {
        if (!$this->venteDetails->contains($venteDetail)) {
            ...
            $venteDetail->setApprovisionnementDetail($this);
        }
    ...
    public function removeVenteDetail(VenteDetail $venteDetail): static
    {
        if ($this->venteDetails->removeElement($venteDetail)) {
            ...
            if ($venteDetail->getApprovisionnementDetail() === $this) {
                $venteDetail->setApprovisionnementDetail(null);
            }
        }
